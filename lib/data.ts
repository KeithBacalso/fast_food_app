//! You might be wondering why inside the `constants` folder there is a file `index.ts` with static constants in it.
//! Why this file `data.ts` is not inside the `constants` folder? — it is because this file represents backend/domain data, not UI constants.
//
//! In short:
